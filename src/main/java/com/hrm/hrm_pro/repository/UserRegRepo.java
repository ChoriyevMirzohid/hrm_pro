...
public interface UserRegRepo extends JpaRepository<UserEntity, Integer> {
    @Query("select new com.hrm.hrm_pro.dto.UserRegDto(a.id, a.fullname, a.email, a.login, a.password, a.condition, a.create_date, a.delete_date) from UserEntity a order by a.create_date desc")
