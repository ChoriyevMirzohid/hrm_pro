...
public interface UserRegRepo extends JpaRepository<User, Integer> {
    ...
    @Query("select new com.hrm.hrm_pro.dto.UserRegDto(a.id, a.fullname, a.email, a.login, a.password, a.condition, a.create_date, a.delete_date) from User a where a.id = :id order by a.create_date desc")
