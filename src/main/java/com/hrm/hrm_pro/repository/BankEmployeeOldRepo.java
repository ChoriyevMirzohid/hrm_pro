...
public interface BankEmployeeOldRepo extends JpaRepository<BankEmployeeOld, Integer> {
    @Query("select new com.hrm.hrm_pro.model.system_emp.BankEmployeeOld(a.emp_id,\n" +
            "a.number,\n" +
            ...
            "COALESCE(a.fullname, '')) from BankEmployeeOld a")
    Page<BankEmployeeOld> getAllBankEmpOldPaging(Pageable pageable);
}
