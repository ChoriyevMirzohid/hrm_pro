...
@AllArgsConstructor
@NoArgsConstructor
public class BankDirectorateDto {
    private Integer id;
    private String code;
    ...
    public BankDirectorateDto(Integer id, String code, Integer block_id, String name_uz, String name_ru, String name_en, Integer deputy_id, String condition, Timestamp create_date, Timestamp delete_date) {
        this.id = id;
        this.code = code;
